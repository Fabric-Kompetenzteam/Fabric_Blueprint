...
# MAGIC   LEFT ANTI JOIN ccurated.dim_customer t
# MAGIC     ON dc.Email = t.Email
# MAGIC )
# MAGIC 
# MAGIC -- Merge new data with existing data 
# MAGIC MERGE INTO ccurated.dim_customer AS target
...
# MAGIC %%sql
# MAGIC SELECT * FROM ccurated.dim_customer LIMIT 10
